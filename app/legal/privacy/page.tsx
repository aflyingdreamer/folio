  ...
  return (
    <main className="mx-auto max-w-2xl px-6 py-24 font-serif text-stone-700 leading-relaxed">
      ...
      <p className="text-balance">
        Your pages belong to you. We don&apos;t sell or share your writing
        with anyone. We use Supabase to store your entries and basic
        account information, and Vercel to serve the site. That&apos;s it.
      </p>
